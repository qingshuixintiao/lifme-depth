...
from thop import profile  # 引入profile函数用于计算FLOPs
...
def count_parameters(model, name=""):
    ...
    print(f"-> {name} - Total parameters: {total_params:,}, Trainable parameters: {trainable_params:,}")
...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        count_parameters(depth_decoder, "Depth Decoder")
        ...
        with torch.no_grad():
            for data in dataloader:
                ...
                print(f"FLOPs: {flops}, Params: {params}, Encoder FLOPs: {flops_e}, Encoder Params: {params_e}, Decoder FLOPs: {flops_d}, Decoder Params: {params_d}")
