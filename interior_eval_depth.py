...
load_weights_folder = r'D:\pyprojects\LiDUT-Depth-master\tmp\fem_demgai_spm_dfm'
...
def evaluate(opt):
    ...
    filenames = readlines('./splits/interior_test.txt')
    dataset = datasets.InteriorTestDataset(
            os.path.join(opt.data_path, 'interiornet_test'),
            filenames,
            thisH, thisW,
    )
    ...
    with torch.no_grad():
        for ind, (data, gt_depth) in enumerate(tqdm(dataloader)):
            ...
            pred_disp, _ = disp_to_depth(disp, 0.1, 10)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str,
                       ...
                       default="D:\Datasets\interiornet_test")
