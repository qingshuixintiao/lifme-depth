...
class LiteMonoOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--data_path",
                                 ...
                                 default=os.path.join(file_dir, "D:\kitti_data"))
        ...
        self.parser.add_argument("--sgt_scales", nargs='+', type=int, default=[2, 1, 0],
        ...
        # 在参数解析器中添加
        self.parser.add_argument("--sgt_temperature", type=float, default=0.1,
                                 help="temperature parameter for SGT loss")
        self.parser.add_argument("--dynamic_margin", default=True, type=bool,
                                 help="use dynamic margin for SGT loss")
        ...
        self.parser.add_argument("--mypretrain",
                                 type=str,
                                 default="pth/lite-mono-small-pretrain.pth",
        ...
        self.parser.add_argument("--load_weights_folder",
                                 type=str,
                                  # default="D:\pyprojects\LiDUT-Depth-master/tmp\WODFM",
