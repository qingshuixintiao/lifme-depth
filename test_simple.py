...
def parse_args():
    ...
    parser.add_argument('--image_path', type=str,
                        ...
                        default="D:\pyprojects\LiDUT-Depth-master\img1/14.png")

    parser.add_argument('--load_weights_folder', type=str,
                        help='path of a pretrained model to use',
                        default="D:\pyprojects\LiDUT-Depth-master/tmp/fem_demgai_spm_dfm\encoder.pth",
                        )
...
def test_simple(args):
    ...
    encoder_path = os.path.join(args.load_weights_folder, "D:\pyprojects\LiDUT-Depth-master/tmp/fem_demgai_spm_dfm\encoder.pth")
    decoder_path = os.path.join(args.load_weights_folder, "D:\pyprojects\LiDUT-Depth-master/tmp/fem_demgai_spm_dfm\depth.pth")
    ...
    depth_decoder.load_state_dict({k: v for k, v in decoder_dict.items() if k in depth_model_dict},strict=False)
    ...
    with torch.no_grad():
        for idx, image_path in enumerate(paths):
            ...
            scaled_disp, depth = disp_to_depth(disp, 0.1, 10)
